...
module.exports = {
  ...
  apps: {
    'ios.debug': {
      type: 'ios.app',
      binaryPath:
        'ios/build/Build/Products/Debug-iphonesimulator/ZingoDelegator.app',
      build:
        "xcodebuild -workspace ios/ZingoDelegator.xcworkspace -scheme ZingoDelegator -configuration Debug -sdk iphonesimulator -derivedDataPath ios/build -destination 'platform=iOS Simulator,name=iPhone 16e,OS=26.1'",
    },
    'ios.release': {
      type: 'ios.app',
      binaryPath:
        'ios/build/Build/Products/Release-iphonesimulator/ZingoDelegator.app',
      build:
        "xcodebuild -workspace ios/ZingoDelegator.xcworkspace -scheme ZingoDelegator -configuration Release -sdk iphonesimulator -derivedDataPath ios/build -destination 'platform=iOS Simulator,name=iPhone 16e,OS=26.1'",
    },
    'android.debug': {
      type: 'android.apk',

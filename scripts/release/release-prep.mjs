...
console.log('  yarn rust:android          # and/or yarn rust:ios');
console.log('');
console.log('Rebuild the rust libs only AFTER the tag exists: build.rs bakes');
console.log('`git describe` into the native lib, and that string is the');
console.log('zingolib line on the About screen. Build them before tagging and');
console.log('the shipped app advertises the previous tag plus a commit count.');
console.log('Neither gradle nor Xcode rebuilds them for you -- the AAB/archive');
console.log('just packages whatever is already there. See');
console.log('docs/release_quickstart.md, "Release order".');
console.log('');

...
const ShowUfvk: React.FunctionComponent<ShowUfvkProps> = ({
  ...
  const renderUfvkFooter = useCallback(
      ...
      <BottomSheetFooter {...props} bottomInset={0}>
        ...
        >
          <Button
            ...
            // Same rationale as Seed.tsx: the button drives the
            // ufvk-dependent confirm/change/backup/server flow; disable
            // when the UFVK is missing so presses don't silently no-op.
    ...
    [colors, texts, action, times, fetchedWallet.ufvk],
  );

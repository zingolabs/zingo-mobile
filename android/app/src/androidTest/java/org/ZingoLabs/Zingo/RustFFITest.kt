...
class ExecuteAddressesFromSeed {
    ...
    fun executeAddressesFromSeed() {
        ...
        val initFromSeedJson: String = uniffi.zingo.initFromSeed(server, seed, birthday, datadir, chainhint)
        println("\nInit from seed:")
...
class ExecuteAddressesFromUfvk {
    ...
    fun executeAddressFromUfvk() {
        ...
        val initFromUfvkJson: String = uniffi.zingo.initFromUfvk(server, ufvk, birthday, datadir, chainhint)
        println("\nInit From UFVK:")
...
class ExecuteSyncFromSeed {
    ...
    fun executeSyncFromSeed() {
        ...
        val syncJson: String = uniffi.zingo.runSyncProcess()
        println("\nSync:")
        println(syncJson)
...
class ExecuteSendFromOrchard {
    ...
    fun executeSendFromOrchard() {
        ...
        var syncJson: String = uniffi.zingo.runSyncProcess()
        println("\nSync:")
        println(syncJson)
        ...
        syncJson = uniffi.zingo.runSyncProcess()
        println("\nSync:")
        println(syncJson)

...
class ExecuteAddressesFromSeed {
    ...
    fun executeAddressesFromSeed() {
        ...
        val initFromSeedJson: String = uniffi.zingo.initFromSeed(serveruri, seed, 1, chainhint, "Medium", 1)
        println("\nInit from seed:")
...
class ExecuteAddressesFromUfvk {
    ...
    fun executeAddressFromUfvk() {
        ...
        val initFromUfvkJson: String = uniffi.zingo.initFromUfvk(serveruri, ufvk, 1, chainhint, "Medium", 1)
        println("\nInit From UFVK:")

...
android {
    ...
    defaultConfig {
        ...
        versionCode = 307 // Real
        versionName = "zingo-2.0.19" // Real
...
androidComponents {
    onVariants { variant ->
        variant.outputs.forEach { output ->
            ...
            output.versionCode.set(baseAbiVersionCode * 10000 + (android.defaultConfig.versionCode ?: 1))
        }
    }
}
...
//        }
        variant.sources.java?.addStaticSourceDirectory(
            layout.buildDirectory.dir("generated/source/uniffi/${variant.name}/java").get().asFile.absolutePath
        )
    }
}

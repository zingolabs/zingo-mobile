...
// Automated testing checks Java_org_ZingoLabs_ZingoFfi_ZingoFfiModule and zingoffi
// by comparing the whole line here.
/*
Java_org_ZingoLabs_ZingoFfi_ZingoFfiModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return zingoffi::multiply(a, b);
}
*/

// Installer coming from ZingoFfiModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_org_ZingoLabs_ZingoFfi_ZingoFfiModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return zingoffi::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_org_ZingoLabs_ZingoFfi_ZingoFfiModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return zingoffi::cleanupRustCrate(*runtime);
}
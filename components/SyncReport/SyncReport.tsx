            ...
            >
              <DetailLine
                ...
                value={
                  ...
                  moment(
                    Number(Number(background.date).toFixed(0)) * 1000,
                  ).format('YYYY MMM D h:mm:ss a') +
                  (Number(background.dateEnd) > 0 &&
                  Number(background.date) !== Number(background.dateEnd)
                    ? moment(
                        Number(Number(background.date).toFixed(0)) * 1000,
                      ).format('YYYY MMM D') ===
                      moment(
                        Number(Number(background.dateEnd).toFixed(0)) * 1000,
                      ).format('YYYY MMM D')
                      ? ' - ' +
                        moment(
                          Number(Number(background.dateEnd).toFixed(0)) * 1000,
